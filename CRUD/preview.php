<?php
  ...
  $connect = connectdb();
    ...
    if( isset($_POST['search']) ){
        ...
        $sql = "SELECT * FROM account WHERE $selectOption ='$searchInput'";
    }
        ...
        <div class="table-container">
            ...
            <thead>
                <tr>
                    ...
                    <th onclick="sortTable(this)">First Name</th>
                    <th onclick="sortTable(this)">Last Name</th>
                    <th onclick="sortTable(this)">Age</th>
                    <th onclick="sortTable(this)">Email</th>
                    <th onclick="sortTable(this)">Address</th>
                    <th onclick="sortTable(this)">Country</th>
