<?php
    ...
    if (isset($_POST['newReservation'])){
        ...
        if ($num >= 1) {
            // $newcustomer = SELECT customer_id FROM customer WHERE firstname ='$fname' AND lastname = '$lname');
            $sql = mysqli_query($connect,"INSERT INTO reservation (checkIn, checkOut, adult, kids, room_cost, request, customer_id) 
            VALUES ('$checkIn', '$checkOut', '$adult', '$kids', '$roomcost', '$request', (SELECT customer_id FROM customer WHERE firstname ='$fname' AND lastname = '$lname'))");
        ...
        if ($num == 0) {
            $sql = mysqli_query($connect,"INSERT INTO customer (firstname, lastname, email, phonenum, country) VALUES ('$fname', '$lname', '$email', '$phone', '$country')");
            $sql = mysqli_query($connect,"INSERT INTO reservation (checkIn, checkOut, adult, kids, room_cost, request, customer_id) VALUES ('$checkIn', '$checkOut', '$adult', '$kids', '$roomcost', '$request', LAST_INSERT_ID())");
