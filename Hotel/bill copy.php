<?php
    ...
    if (isset($_POST['newReservation'])){
        ...
        $values = implode("', '", $data);
        $sql = "INSERT INTO reservation ($keys) VALUES ('$values')";
            ...
            <div class="divcon">
                <div class="container col-4 card2">
                    <form action="" method="post" id="myForm">
                        ...
                        <input name="phone" id="phone" class="phone input-field" type="tel" placeholder="0912-345-6789" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" required><br><br>
